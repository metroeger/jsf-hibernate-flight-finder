...
public class RoutePlan {
    ...
    public RoutePlan() {
        ...
        choosenDestination = "";
        routes.sort((o1,o2)->{
            int cName = o1.getOrigin().getName().compareTo(o2.getOrigin().getName());
            return cName;
        });
    ...
    public String show() {
        answer = "";
        answer = firstAirport.toString();
        
        for (int i=way.size()-1; i>=0; i--){
            if (i>0 && way.get(i)!=firstAirport){
                answer += "->" + way.get(i);
            }
        }
        return answer;
    ...
    public List reverse(){
        ...
        List<Route> rs = new ArrayList<>();
         for (int i = getFinalWay().size() - 1; i >= 0; i--) {
            if (getFinalWay().get(i).getWeightNow() != 0) {               
                rs.add(finalWay.get(i));
                stopCounter++;
            }         
        }
         return rs;
